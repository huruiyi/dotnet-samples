...
namespace Astellas_Barcode.Models.Printer
{
    /// <summary>
    /// Summary description for Code128Rendering.
    /// </summary>
    public static class HHTCode128Rendering
    {
        ...
        public static Image MakeBarcodeImage(string InputData, int BarWeight, bool AddQuietZone)
        {
            ...
            int width, height;
            height = _height;
            width = GetBarcodeImageRealWidth(codes, BarWeight, AddQuietZone);//( (codes.Length-3) * 11 + 35) * BarWeight;//400;
            //height = 60;// Convert.ToInt32(System.Math.Ceiling(Convert.ToSingle(width) * .15F));
