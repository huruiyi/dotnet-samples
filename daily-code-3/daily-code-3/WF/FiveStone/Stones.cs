...
namespace FiveStone
{
    public class Stones
    {
        ...
        public Stones(Graphics g)
        {
            ...
            Stream bStream = myAssembly.GetManifestResourceStream("FiveStone.Resource.black.png");
            Stream wStream = myAssembly.GetManifestResourceStream("FiveStone.Resource.white.png");
