...
namespace ConApp.OtherDemo
{
    ...
    public class DemonstrateAsyncPattern
    {
        ...
        public void FactorizeNumberUsingCallback()
        {
            ...
            IAsyncResult result = factorDelegate.BeginInvoke(number, ref temp, ref temp, callBack, number);
        ...
        public void FactorizeNumberAndWait()
        {
            ...
            // Output the results.
            Console.WriteLine("Sequential : Factors of {0} : {1} {2} - {3}", number, factor1, factor2, answer);
        }
    }
}