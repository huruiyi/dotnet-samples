...
namespace HuUtils {
    ...
    public partial class ExampleDb : global::System.Data.DataSet {
        ...
        public partial class AdminRow : global::System.Data.DataRow {
            ...
            public long Id {
                get {
                    return ((long)(this[this.tableAdmin.IdColumn]));
                }
                set {
...
namespace HuUtils.ExampleDbTableAdapters {
...
SELECT Id, UserName, Password FROM Admin WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::HuUtils.Properties.Settings.Default.ExampleDbConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT   Id, Password, UserName\r\nFROM      Admin\r\nWHERE   (Id = @Id)";
        ...
        public virtual int Fill(ExampleDb.AdminDataTable dataTable) {
        ...
        public virtual ExampleDb.AdminDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ExampleDb.AdminDataTable dataTable = new ExampleDb.AdminDataTable();
        ...
        public virtual int FillBy(ExampleDb.AdminDataTable dataTable, long Id) {
        ...
        public virtual ExampleDb.AdminDataTable FillById(long Id) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((long)(Id));
            ExampleDb.AdminDataTable dataTable = new ExampleDb.AdminDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ExampleDb.AdminDataTable dataTable) {
