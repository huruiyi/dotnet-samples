...
namespace _058_064_LINQ___Element_Operators
{
    internal class Program
    {
        ...
        private class LinqSamples
        {
            ...
            [Category("Element Operators")]
            [Description("This sample uses FirstOrDefault to try to return the first element of the sequence, unless there are no elements, in which case the default value for that type " +
