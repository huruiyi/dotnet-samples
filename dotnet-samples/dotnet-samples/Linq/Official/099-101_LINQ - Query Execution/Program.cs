...
namespace _099_101_LINQ___Query_Execution
{
    internal class Program
    {
        ...
        private class LinqSamples
        {
            ...
            public void Linq101()
            {
                ...
                // During this second run, the same query object, lowNumbers, will be iterating over
                // the new state of numbers[], producing different results:
